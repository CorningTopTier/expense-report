...
class ExpenseReportTests(unittest.TestCase):
    ...
    # def test_should_output_header_followed_by_expense_data_with_expense_report_with_one_expense(self):
    #     # Given
    #         # an expense report without any expense
    #     expense_report = ExpenseReport(date="6/05/1998", description="Gasoline", amount=52.25, balance=1586.24)  # an expense report without any expense
    #
    #     # When
    #     expense_report_output = expense_report.generate_report()
    #
